# cloude_decom
Near-real-time interactive implementation of **Cloude Decomposition** [1] by [Shane R Cloude](https://scholar.google.ca/citations?hl=en&user=h-ZWMcUAAAAJ&view_op=list_works&sortby=pubdate) supporting quick exploration of fully-polarimetric [SAR](https://earthdata.nasa.gov/learn/backgrounders/what-is-sar) Earth-observation data such as from [NISAR](https://nisar.jpl.nasa.gov/), [ALOS PALSAR](https://asf.alaska.edu/data-sets/sar-data-sets/alos-palsar/), or [RADARSAT-2](https://www.asc-csa.gc.ca/eng/satellites/radarsat2/Default.asp)
