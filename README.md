# cloude_decom
High-performance interactive implementation of **Cloude Decomposition** [1] by [Shane R Cloude](https://scholar.google.ca/citations?hl=en&user=h-ZWMcUAAAAJ&view_op=list_works&sortby=pubdate). Required inputs:
* T3 coherency matrix data in [PolSARPro](https://ietr-lab.univ-rennes1.fr/polsarpro-bio/) format
